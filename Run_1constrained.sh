...
do
	...
	do
		for agent in her_triangle #baseline
		do
			for trianglescale in  0.0 
			do
				...
				./run_constrained.sh $seed $gpu $agent $env $trianglescale $hlactornum $USE_CAPABLE $USE_MULTI_LL $USE_VISUALIZE> trainlogs/${hlactornum}_${env}_${agent}_${trianglescale}_${seed}_${dimlatent}_${USE_CAPABLE}_${USE_MULTI_LL}.log 2>&1 &
